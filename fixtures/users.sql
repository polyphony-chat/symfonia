...
VALUES 
    (7248639845155737600, 'john_doe', '1296', 'avatar1.png', 16777215, 'banner1.png', '{"light": "#FFFFFF", "dark": "#000000"}', 
     ...
     5, 1, 100, '{"key": "value"}', 'fingerprint1', '{"setting": "value"}', 1, 
     '[]'),
    (7248639891561517057, 'jane_smith', '5678', 'avatar2.png', 123456, NULL, NULL, 
     ...
     0, 0, 50, '{"info": "details"}', 'fingerprint2', '{"setting": "another_value"}', 2, 
     '[]'),
    (7248640296244744192, 'alice_malice', '9876', 'avatar3.png', 987654, 'banner3.png', '{"light": "#FFA500", "dark": "#FF4500"}', 
    ...
    2, 1, 150, '{"key3": "value3"}', 'fingerprint3', '{"setting3": "value3"}', 3, 
    '[]'),
    (7248640311927246848, 'bob_the_woz', '1122', 'avatar4.png', 556677, NULL, '{"light": "#0000FF", "dark": "#8A2BE2"}', 
     ...
     3, 2, 200, '{"key4": "value4"}', 'fingerprint4', '{"setting4": "value4"}', 4, 
     '[]'),
    (7248640327265816576, 'xenia', '3344', 'avatar5.png', NULL, 'banner5.png', '{"light": "#D2691E", "dark": "#8B4513"}', 
     ...
     0, 0, 180, '{"key5": "value5"}', 'fingerprint5', '{"setting5": "value5"}', 5, 
     '[]');
COMMIT;