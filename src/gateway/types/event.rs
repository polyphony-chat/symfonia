...
impl TryFrom<tokio_tungstenite::tungstenite::Message> for Event {
    ...
    fn try_from(message: tokio_tungstenite::tungstenite::Message) -> Result<Self, Self::Error> {
        ...
        match dispatch_event_type {
            ...
            DispatchEventType::ApplicationCommandPermissionsUpdate => convert_to!(
            ...
            DispatchEventType::AutoModerationActionExecution => convert_to!(
                DispatchEvent::AutoModerationActionExecution,
                message_as_string
            )
            .map(Event::Dispatch),
            DispatchEventType::AutoModerationMentionRaidDetection => convert_to!(
            ...
            DispatchEventType::GuildScheduledEventUserRemove => convert_to!(
