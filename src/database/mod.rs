...
pub async fn seed_config(db: &MySqlPool) -> Result<(), Error> {
    ...
    sqlx::query(r#"INSERT INTO config (`key`, value) VALUES ('defaults_guild_explicitContentFilter', '0');"#).execute(db).await?;
    sqlx::query(
        r#"INSERT INTO config (`key`, value) VALUES ('defaults_guild_maxPresences', '250000');"#,
    )
    .execute(db)
    .await?;
    sqlx::query(r#"INSERT INTO config (`key`, value) VALUES ('defaults_guild_maxVideoChannelUsers', '200');"#).execute(db).await?;
    ...
    .execute(db)
    .await?;
    sqlx::query(r#"INSERT INTO config (`key`, value) VALUES ('guild_discovery_useRecommendation', 'false');"#).execute(db).await?;
    ...
    .execute(db)
    .await?;
    sqlx::query(r#"INSERT INTO config (`key`, value) VALUES ('limits_rate_routes_auth_login_window', '60');"#).execute(db).await?;
